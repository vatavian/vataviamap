Public Class frmDownloadMobile
    ...
    Private Sub txtGPSSymbolSize_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtGPSSymbolSize.KeyDown
        On Error Resume Next
        Select Case e.KeyCode
            Case Keys.Left, Keys.Down
                Dim lVal As Integer = 0
                lVal = CInt(txtGPSSymbolSize.Text) - 1
                If lVal < 0 Then lVal = 0
                txtGPSSymbolSize.Text = CStr(lVal)
    ...
    Private Sub frmOptionsMobile_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
        FormatLatLon()
        Select Case DegreeFormat
            Case EnumDegreeFormat.DecimalDegrees
