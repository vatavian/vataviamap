...
namespace GPS_API
{
    ...
    public class GpsPosition
    {
        ...
        // Horizontal Dilution Of Precision - A value of 1.0 indicates the least dilution (highest accuracy); a value of 50.0 indicates the most dilution (lowest accuracy)
